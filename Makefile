...
.PHONY: all run clean distclean check help dirs test-resource-archive test-resource-manager-sdl3 test-sdl3-primary-present test-dplay-config menu-sprite-viewer run-menu-sprite-viewer test-menu-sprite-viewer
