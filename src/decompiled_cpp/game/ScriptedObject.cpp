...
/**
 * ScriptedObject::~ScriptedObject — Virtual destructor (vtable[0])
 * Address: 0x4494C0 (body)
 *
 * Tears down all sub-objects. The scalar-deleting wrapper (flags & 1
 * → GLOBAL_free) is generated by the compiler.
 */
ScriptedObject::~ScriptedObject()
{
    this->InitSubObjects();
